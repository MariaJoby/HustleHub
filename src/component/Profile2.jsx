  ...
  return (
    <div className="bg-[#0B1221] min-h-screen text-white px-6 md:px-20 py-16 space-y-8">
      ...
      <div className="max-w-4xl mx-auto bg-[#071022] p-6 rounded-lg flex flex-col md:flex-row gap-4 justify-between">
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 bg-orange-500 rounded" onClick={() => navigateApp("/post-gig")}>Post a gig</button>
          <button className="px-4 py-2 border rounded" onClick={() => navigateApp("/my-campus")}>Go to My Campus</button>
...
// helper uses global navigateApp
