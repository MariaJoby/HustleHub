    ...
    <div className="bg-[#0B1221] min-h-screen text-white">
      ...
      <nav className="flex justify-between items-center px-6 md:px-20 py-5">
        ...
        <ul className="hidden md:flex gap-8 text-gray-300 font-medium">
          <li className="hover:text-white cursor-pointer">See Gigs</li>
          <li className="hover:text-white cursor-pointer">Post gigs</li>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-3 flex-wrap">
              <button
                onClick={() => (window.navigateApp ? window.navigateApp("/skill-exchange") : (window.location.href = "/skill-exchange"))}
      ...
      <section className="px-6 md:px-20 py-16 bg-[#071022]">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-3 flex-wrap">
              <button
                onClick={() => (window.navigateApp ? window.navigateApp("/note-selling") : (window.location.href = "/note-selling"))}
                className="px-4 py-2 bg-orange-500 hover:bg-orange-600 rounded font-semibold transition"
              >
                Explore All
              </button>
      ...
      <section className="px-6 md:px-20 py-16 bg-[#0B1221]">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-3 flex-wrap">
              <button
                onClick={() => (window.navigateApp ? window.navigateApp("/tutoring") : (window.location.href = "/tutoring"))}
                className="px-4 py-2 bg-orange-500 hover:bg-orange-600 rounded font-semibold transition"
              >
                Explore All
              </button>
      ...
      <section className="px-6 md:px-20 py-16 bg-[#071022]">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-3 flex-wrap">
              <button
                onClick={() => (window.navigateApp ? window.navigateApp("/item-exchange") : (window.location.href = "/item-exchange"))}
                className="px-4 py-2 bg-orange-500 hover:bg-orange-600 rounded font-semibold transition"
              >
                Explore All
              </button>
