      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16">
        <div className="flex-1 max-w-xl text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center md:justify-start">
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold transition-all">
              Browse gigs
            </button>
            <button className="border border-orange-400 hover:bg-orange-500 hover:text-white text-orange-400 px-6 py-3 rounded-lg font-semibold transition-all">
              Post gigs
            </button>
          </div>
        </div>
