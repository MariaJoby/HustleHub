...
// create safe lazy imports with simple fallback components so missing files won't break Vite
...
export default function App() {
  ...
  // route mapping using Suspense for lazy-loaded pages
  if (route === "/post-gig") {
    return (
    ...
    <div className="bg-[#0B1221] min-h-screen text-white">
      ...
      <nav className="flex justify-between items-center px-6 md:px-20 py-5">
        ...
        <ul className="hidden md:flex gap-8 text-gray-300 font-medium">
          <li className="hover:text-white cursor-pointer" onClick={() => navigateApp("/browse-gigs")}>
            See Gigs
          </li>
          <li className="hover:text-white cursor-pointer" onClick={() => navigateApp("/post-gig")}>
            Post gigs
          </li>
          <li className="hover:text-white cursor-pointer" onClick={() => navigateApp("/my-campus")}>
            My Campus
          </li>
          <li className="hover:text-white cursor-pointer">Map View</li>
          <li className="hover:text-white cursor-pointer" onClick={() => navigateApp("/profile")}>
            My Profile
          </li>
        </ul>
